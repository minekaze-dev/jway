...
const GuidePreview: React.FC<GuidePreviewProps> = ({ guide }) => {
    return (
        <div className="bg-gray-900/50 p-6 rounded-lg border border-gray-700 h-full flex flex-col gap-8">
            <div>
                <h4 className="text-lg font-bold text-gray-100 mb-3 text-center">Preview Kartu</h4>
                <div className="max-w-sm mx-auto">
                    {/* The component is clickable, but we disable the action here */}
                    <GuideCard guide={guide} onOpenDetail={() => {}} />
                </div>
            </div>

            <div className="border-t border-gray-700 pt-6 flex-1 min-h-0">
                <h4 className="text-lg font-bold text-gray-100 mb-3 text-center">Preview Detail</h4>
                <div className="bg-gray-800 p-4 rounded-lg overflow-y-auto h-full">
